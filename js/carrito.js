...
async function cargarCarrito() {
  ...
  items.forEach((it) => {
    ...
    el.innerHTML = `<h4>${it.nombre}</h4><p>$${it.precio} x ${it.cant}</p><div class="botones"><button data-id="${it.id}" class="boton">-</button><button data-id="${it.id}" class="boton">+</button></div>`;
